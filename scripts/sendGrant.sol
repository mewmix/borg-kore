...
contract BaseScript is Script {
  ...
  address newR = 0x9EfbfE69a522aC81685e21EEb52aFBd5398b2CBc;
  IGnosisSafe safe;
  //borgCore core;
  ejectImplant eject;
  ...
  FlexGovernanceAdapter governanceAdapter;
     ...
     function run() public {
            ...
            executeSingle(createGrant(token, newR, 100 * 10**18));
            vm.stopBroadcast();
        }
    ...
    function createGrant(address token, address to, uint256 amount) public returns (GnosisTransaction memory) {
        ...
        return GnosisTransaction({to: op, value: 0, data: guardData});
    }
