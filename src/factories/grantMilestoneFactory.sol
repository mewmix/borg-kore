...
contract GrantMilestonesFactory is GlobalACL {
    ...
    event GrantMilestonesDeployed(address indexed contractAddress, address indexed receipient, address indexed borgSafe, address revokeConditions);
    ...
    function deployGrantMilestones(
        ...
        require(_receipient != address(0), "Receipient cannot be the zero address.");

        GrantMilestones newGrantMilestones = new GrantMilestones(_receipient, _borgSafe, _revokeConditions, _milestones);
        emit GrantMilestonesDeployed(address(newGrantMilestones), _receipient, _borgSafe, _revokeConditions);
